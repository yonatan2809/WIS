          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="col-3">
                    <a href="tambah_siswa" class="btn btn-block btn-lg btn-success float-left">Tambah Data Siswa</a>
                    <br>
                    <br>
                    <br>
                  </div>
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $query = "SELECT * FROM data_siswa ORDER BY tahun_angkatan DESC";
                      // Query untuk menampilkan semua data produk
                      $sql = mysqli_query($koneksi, $query); // Eksekusi/Jalankan query dari variabel $query
                      while ($data = mysqli_fetch_array($sql)) { // Ambil semua data dari hasil eksekusi $sql
                          echo "<td>" . $data['nama_siswa'] . "</td>";
                          echo "<td>" . $data['kelas'] . "</td>";
                          echo "<td>" . $data['tahun_angkatan'] . "</td>";
                          echo "<td><center>
                          <a href='ubah_siswa?change=" . $data['id_siswa'] . "'>
                          <i class='fas fa-pencil-alt' title='Ubah'></i></a>
                          &nbsp;|&nbsp; 
                          <a href='../proses/delete_siswa?hapus=" . $data['id_siswa'] . "'>
