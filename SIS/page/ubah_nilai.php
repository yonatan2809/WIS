          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-info">
                ...
                $query = "SELECT * FROM data_nilai WHERE id_siswa='" . $id_siswa . "'";
                $sql = mysqli_query($koneksi, $query);  // Eksekusi/Jalankan query dari variabel $query
                $data = mysqli_fetch_array($sql); // Ambil data dari hasil eksekusi $sql
                ?>
                <!-- form start -->
                <form class="form-horizontal" method="POST"
                  action="../proses/change_nilai.php?change=<?php echo $id_siswa; ?>" enctype="multipart/form-data">
                  <div class="card-body">

                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Nama Siswa</label>
                      <div class="col-sm-10">
                        <select class="form-control select2" name="id_siswa" style="width: 100%;" required>
                          <?php
                          ...
                          <option value="<?php echo $data['id_siswa']; ?>">
                            <?php echo "Nama :$data[nama_siswa]/Kelas :$data[kelas]/Tahun Angkatan :$data[tahun_angkatan]";
                            }
                            ?>
                          </option>
                        </select>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <select class="form-control select2" name="id_mapel" style="width: 100%;" required>
                          <?php
                          ...
                          <option value="<?php echo $data['id_mapel']; ?>">
                            <?php echo "Nama :$data[nama_guru]/Mata Pelajaran :$data[mapel]";
                          }
                          ?>
                        </select>
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <select class="form-control select2" name="ujian" style="width: 100%;">
                          <option selected="selected">UTS</option>
                  ...
                  <div class="card-footer">
                    ...
                    <a href="data_nilai" class="btn btn-block btn-default">Kembali</a>
