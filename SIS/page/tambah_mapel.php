          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal"  method="POST" action="../proses/add_mapel.php" enctype="multipart/form-data">
                  <div class="card-body">

                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Nama Guru</label>
                      <div class="col-sm-10">
                        <select class="form-control select2" name="nama_guru" style="width: 100%;" required>
                          <?php
