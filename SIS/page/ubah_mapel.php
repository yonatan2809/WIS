            ...
            <div class="col-md-12">
              ...
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">Ubah Data MaPel</h3>
                </div>
                <!-- /.card-header -->
                ...
                $query = "SELECT * FROM data_pelajaran WHERE id_mapel='" . $id_mapel . "'";
                ...
                <form class="form-horizontal" method="POST"
                  action="../proses/change_mapel.php?change=<?php echo $id_mapel; ?>" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        ...
                        // Load file koneksi.php
                        include "../proses/koneksi.php";
                        $query2 = "SELECT data_guru.id_guru,
                                    ...
                                    WHERE data_pelajaran.id_mapel = $id_mapel"; // Query untuk menampilkan semua data dari inner join data penjual dengan data_mapel

                        $sql2 = mysqli_query($koneksi, $query2);  // Eksekusi/Jalankan query dari variabel $query
                        $data2 = mysqli_fetch_array($sql2); // Ambil data dari hasil eksekusi $sql
                        ?>
                          <option value="<?php echo $data2['id_guru']; ?>" selected>
                          ...
                          $no++;
                          ?>
                          <option value="<?php echo $data['id_guru']; ?>">
                    ...
                    <div class="form-group row">
                      <label for="inputPassword3" class="col-sm-2 col-form-label">MaPel</label>
                      <div class="col-sm-10">
                  ...
                  <div class="card-footer">
                    ...
                    <a href="data_mapel" class="btn btn-block btn-default">Kembali</a>
                  </div>
                  <!-- /.card-footer -->
                </form>
              </div>
