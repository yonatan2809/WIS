          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="../proses/change_siswa.php?change=<?php echo $id_siswa; ?>" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="number" class="form-control" name="tahun_angkatan" value="<?php echo $data['tahun_angkatan'] ?>" required>
                      </div>
                    </div>
                  ...
                  <div class="card-footer">
                    <input type="submit" class="btn btn-block btn-lg btn-outline-success" value="Ubah Data">
