          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="../proses/add_guru.php" enctype="multipart/form-data">
                  <div class="card-body">
                  ...
                  <div class="card-footer">
                    <input type="submit" class="btn btn-block btn-outline-success" value="Simpan Data">
