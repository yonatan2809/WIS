          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="col-3">
                    <a href="tambah_guru" class="btn btn-block btn-lg btn-success float-left">Tambah Data Guru</a>
                    <br>
                    <br>
                    <br>
                  </div>
