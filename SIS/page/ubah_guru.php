          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="data_guru" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="../proses/change_guru.php?change=<?php echo $id_guru; ?>" enctype="multipart/form-data">
                  <div class="card-body">
                  ...
                  <div class="card-footer">
                    <input type="submit" class="btn btn-block btn-outline-success" value="Ubah Data">
                    <a href="data_guru" type="submit" class="btn btn-block btn-default">Kembali</a>
                  </div>
                  <!-- /.card-footer -->
                </form>
              </div>
